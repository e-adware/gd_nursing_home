...
function new_entry()
{
	...
	window.location='index.php?param='+btoa(176);
}
function add_data()
{
...
function add_item_temp()
{
	...
	var gst_text=$("#gst_text").text().trim();
	if(tr_len==0)
	{
		...
		test_add+="<th style='text-align:right;'>"+gst_text+" %</th>";
...
function save_data_final()
{
	...
	else if(parseFloat($("#bill_amt").val().trim())==0)
	{
		$("#bill_amt").focus();
	}
