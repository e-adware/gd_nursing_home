...
function atload_refdoc(val,e)
{
		...
		if(unicode!=13)
		{
			...
			else if(unicode==40)
			{
				...
				{
					doc_tr=doc_tr+1;
					$("#atdoc"+doc_tr).css({'color': '#419641','transform':'scale(0.95)','font-weight':'bold','transition':'all .2s'});
					var doc_tr1=doc_tr-1;
					$("#atdoc"+doc_tr1).css({'color': 'black','transform':'scale(1.0)','font-weight':'normal','transition':'all .2s'});
					var z3=doc_tr%1;
					if(z3==0)
					{
						$("#atref_doc").scrollTop(doc_sc)
						doc_sc=doc_sc+30;
					}
				}
			}
		...
		else
		{
			...
			if(cen_chk1!=0)
			{
				var docs=document.getElementById("atdvdoc"+doc_tr).innerHTML.split("#");
				var doc_naam=docs[2].trim()
...
function adload_refdoc(val,e)
{
		...
		if(unicode!=13)
		{
			...
			else if(unicode==40)
			{
				...
				{
					doc_tr=doc_tr+1;
					$("#addoc"+doc_tr).css({'color': '#419641','transform':'scale(0.95)','font-weight':'bold','transition':'all .2s'});
					var doc_tr1=doc_tr-1;
					$("#addoc"+doc_tr1).css({'color': 'black','transform':'scale(1.0)','font-weight':'normal','transition':'all .2s'});
					var z3=doc_tr%1;
					if(z3==0)
					{
						$("#adref_doc").scrollTop(doc_sc)
						doc_sc=doc_sc+30;
					}
				}
			}
		...
		else
		{
			...
			if(cen_chk1!=0)
			{
				var docs=document.getElementById("addvdoc"+doc_tr).innerHTML.split("#");
				var doc_naam=docs[2].trim()
...
function pat_visit_type_up(e)
{
	...
	if(unicode==13)
	{
		...
		{
			if($('.police_detail:visible').size() > 0)
			{
