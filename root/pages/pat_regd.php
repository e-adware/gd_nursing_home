	...
	<table class="table">
		...
		<!--<tr>
			...
			<td colspan="5">
				...
				<?php
				$center_qry=mysqli_query($GLOBALS["___mysqli_ston"], " SELECT * FROM `centremaster` order by `centrename` ");
	...
	<table class="table">
		...
		<tr>
			...
			<td>
				...
				<input type="button" name="new_doc" id="new_doc" value="New" class="btn btn-default" onClick="load_new_ref_doc()" />
				<div id="doc_info"></div>
				<div id="ref_doc" align="center">
					<table style="background-color:#FFF" class="table table-bordered table-condensed" id="center_table" width="600px">
						<th>Doctor ID</th>
		...
		<!--<tr>
			...
			<td colspan="5">
				...
				while($center=mysqli_fetch_array($center_qry))
				{
					if($center['centreno']=="C100"){ $sel="selected"; }else{ $sel=""; }
					echo "<option value='$center[centreno]' $sel >$center[centrename]</option>";
				}
				?>
				</select>
