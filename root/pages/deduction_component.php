...
<div id="content-header">
    <div class="header_div"> <span class="header">Deduction Component</span></div>
</div>
<!--End-header-->
<div class="container-fluid">
	<div class="span5" style="margin-left: 0;">
		<table class="table table-bordered table-condensed">
			<tr>
				<td>Deduction Name <input type="text" id="id" style="display:none;" /></td>
				<td><input type="text" id="name" class="span3" placeholder="Deduction Name" autofocus /></td>
			</tr>
			<tr>
...
<script>
	...
	{
		$.post("pages/deduction_component_ajax.php",
		{
			srch:$("#srch").val(),
			type:"load_component",
		},
