			...
			<table class="table table-striped table-bordered table-condensed">
				<tr>
					...
					<td>
						...
						<input type="text" name="group_id" id="group_id" class="imp" readonly>
					</td>
				</tr>
				<tr>
					<th>Group Name</th>
					<td>
						...
						<input type="text" name="group_name" id="group_name" class="imp" onkeyup="group_name(event)" autofocus />
					</td>
				</tr>
				<tr>
					<td colspan="2" style="text-align:center" >
						...
						<input type="button" name="button3" id="button3" onclick="popitup('pages/charge_group_print.php')" value="View" class="btn btn-info" />
					</td>
				</tr>
			</table>
		</div>
...
<script>
	...
	function group_name(e)
	{
		var str=$("#group_name").val();
	...
	function val_load_new(doid1)
	{
		$.post("pages/global_load.php",
		{
			type:"charge_group_load",
			doid1:doid1,
		},
		function(data,status)
		{		
			var val=data.split("@");
			document.getElementById("group_id").value=val[0];
			document.getElementById("group_name").value=val[1];
		 })
	}
	function clearr()
	{
