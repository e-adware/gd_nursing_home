...
if($_POST["type"]=="patient_wise")
{
	$visit_type_id=trim($_POST['visit_type_id']);
...
?>
	<p style="margin-top: 2%;" id="print_div"><b>Patient Visit Reports from:</b> <?php echo convert_date($date1)." <b>to</b> ".convert_date($date2); ?>
		...
		<button type="button" class="btn btn-info btn-mini text-right" onclick="print_page('<?php echo $_POST["type"]; ?>','<?php echo $date1;?>','<?php echo $date2;?>','<?php echo $visit_type_id;?>')" style="margin-right: 1%;"><i class="icon-print icon-large"></i> Print</button>
	</p>
