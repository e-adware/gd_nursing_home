		...
		<div class="" style="margin-left:0px;">
			...
			<table class="table table-condensed">
				<tr>
					...
					<td colspan="3">
						<select id="substore_id" class="span4" autofocus>
					...
					<th></th>
					<td colspan="3">
						<input type="text" id="issue_to" class="imp" style="display:none;" />
					</td>
				</tr>
				<tr>
				   <th>Item Name</th>
				   <td colspan="3">
					<input type="text" id="r_doc" class="span5" size="25" onFocus="load_refdoc1()" onKeyUp="load_refdoc(this.value,event,'item')" onBlur="$('#ref_doc').fadeOut(500)" value="" placeholder="Item Name OR Code" />
...
<script src="../jss/ph_item_return_to_store.js"></script>
