...
<div class="container">
	...
	$filename ="discount_report_".$date1."_to_".$date2.".xls";
	...
	?>
	<p style="margin-top: 2%;"><b>Discount Report from:</b> <?php echo convert_date($date1)." <b>to</b> ".convert_date($date2); ?></p>
...
?>
		<tr>
			<td colspan="3"></td>
			<td><span class="text-right"><strong>Total:</strong></span></td>
