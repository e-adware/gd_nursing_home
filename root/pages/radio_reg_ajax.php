...
if($type=="lab_pat_insert")
{
	...
	if($typ=="save_lab_pat_info")
	{
		...
		if($check_double_entry==0)
		{
			...
			{
				mysqli_query($link,"INSERT INTO `patient_info_rel`(`patient_id`,`credit`, `gd_phone`, `crno`, `pin`, `police`, `state`, `district`, `city`, `file_no`, `post_office`) VALUES ('$new_patient_id','$credit','$g_ph','$crno','$pin','$police','$state','$dist','$city','$fileno','$post_office')");
