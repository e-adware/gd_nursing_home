...
<table class="table table-condensed table-bordered">
	<tr>
		<th colspan="8" style="text-align:center;"><h4>Discount Report from <?php echo convert_date($fdate);?> to <?php echo convert_date($tdate);?></h4></th>
	</tr>
	<tr>
		<th>Sl No</th>
		<th>Bill No</th>
	...
	<?php
	$n=1;
	$q=mysqli_query($link,"SELECT * FROM `ph_sell_master` WHERE `entry_date` BETWEEN '$fdate' AND '$tdate' and discount_amt>0 order by slno");
