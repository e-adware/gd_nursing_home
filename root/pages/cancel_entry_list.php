...
<script>
	...
	function view_all()
	{
		...
		{
			type:"patient_cancel_request_list",
			val:$("#search_data").val(),
	...
	function approve_patient_cancel_request(uhid,opd_id,slno)
	{
			...
			buttons: {
				...
				confirm: {
					...
					callback: function() {
						...
						bootbox.dialog({ message: "<span id='discharge_text'><b>Approving</b> <img src='../images/loading.gif' height='10' width='30'/> <img src='../images/loading.gif' height='10' width='30'/> <img src='../images/loading.gif' height='10' width='30'/> <img src='../images/loading.gif' height='10' width='30'/> <img src='../images/loading.gif' height='10' width='30'/> </span>",closeButton: false});
						
						$.post("pages/cancel_request_data.php",
						{
							//~ type:"approve_patient_cancel_request",
