...
<div id="content-header">
    <div class="header_div"> <span class="header"> Method Master</span></div>
</div>
<!--End-header-->
			...
			<table class="table table-striped table-bordered table-condensed">
				...
				<tr>
					...
					<td>
						...
						<input type="text" name="txtname" id="txtname" class="imp" size="35" value="" autocomplete="off" />
					</td>
				</tr>						   
				<tr>
...
<script>
	...
	function Insert() //For Insert
	{
		...
		if(jj==1)
		{
			...
			{
				type:"testmethod",
				docid:document.getElementById("txtid").value,
				docname:document.getElementById("txtname").value,
			},
			function(data,status)
			{
