		...
		<div class="row">
			<div class="col-md-12">
				...
				<table class="table table-bordered table-condensed table-report">
					...
					<?php 
						$query=mysqli_query($GLOBALS["___mysqli_ston"]," SELECT * FROM `cleaning_item_master` order by `item_id` ");
						while($query1=mysqli_fetch_array($query)){
					?>
					<tr>
						<td><?php echo $query1['item_id']; ?></td>
						<td><?php echo $query1['item_name']; ?></td>
					</tr>
					<?php } ?>
				</table>
			</div>
