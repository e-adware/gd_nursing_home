...
foreach($dct as $d)
{
	if($d>-1)
	{
		...
		if($all_test)
		{
			...
			?>
			<img src="../../images/penguin_header.jpg" type="image/jpg/png" style="width:1000px;margin-top:-20px;margin-bottom:0px;margin-right:-50px;" />
...
<?php
	...
	//~ if($_GET[mail]==1) //-------Mail Report----//
	//~ {
		//~ $file_name="../../pdf_files/".$rg.".pdf";
		//~ $m_chk="F"; //--Save File--//
	//~ }
	//~ else
	//~ {
