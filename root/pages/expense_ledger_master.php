...
<html>
	...
	{
		$("#loader").show();
		$.post("pages/expense_ledger_master_ajax.php",
		{
			type:1,
			val:$("#txtcustnm").val()
		},
...
<div id="content-header">
    <div class="header_div"> <span class="header">Ledger Master</span></div>
</div>
<!--End-header-->
		...
		<form id="form1" method="post">
			...
			<div class="span5">
				<table class="table table-bordered table-condensed">
					<tr>
						<td>Item Search</td>
						<td> <input type="text" name="txtcustnm" size="30" id="txtcustnm"  autocomplete="off" class="intext" onkeyup="load_item()" placeholder="Search..." /></td>
					</tr>
				</table>
