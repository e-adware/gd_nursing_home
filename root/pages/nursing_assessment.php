		 ...
		 <tr>
			...
			<td class="">
				...
				<?php
					...
					$pid = mysqli_query($link," SELECT DISTINCT(`patient_id`) FROM `uhid_and_opdid` WHERE `type`='1' order by `slno` DESC");
...
<script>
	...
	{
		window.location="processing.php?param=87&uhid="+uhid+"&opd="+opd;
	}
</script>
