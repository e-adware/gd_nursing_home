...
?>
<script src="../jss/pay_recv_opd.js"></script>
<!--header-->
...
<div class="container-fluid">
	<form id='p_receive'>
		...
		<div id="butts" align="center">
			...
			<input type="button" name="mrec" id="mrec" value="Cash Receipt" class="btn btn-custom" onClick="print_mon('pages/print_cash_receipt_opd.php?id=0')" />
		</div>
	</form>
