	...
	<body onafterprint="window.close();" onkeypress="close_window(event)">
		<div class="container-fluid">
			...
			<div>
				...
				<?php if($paym_final_dis["discount"]>0){ ?>
				<tr>
					<td colspan="5">
				...
				<?php }else{
					$pat_balance=$tot-$summ_adv-$paym_final_dis["discount"];
					if($pat_balance>=0)
					{
				...
				<tr>
					<td colspan="5">
						<b class="text-right" style="border-right:1px solid #000;">Paid &nbsp; </b></td><td> &nbsp; <?php echo number_format($summ_final,2);?>
					</td>
				</tr>
				<?php } } ?>
				<?php
