		...
		<div class="row">
			<div class="col-md-12">
				...
				<table class="table table-bordered table-condensed table-report">
					...
					<?php 
						$query=mysqli_query($GLOBALS["___mysqli_ston"]," SELECT * FROM `cleaning_material_master` order by `item_mat_id` ");
						while($query1=mysqli_fetch_array($query)){
					?>
					<tr>
						<td><?php echo $query1['item_mat_id']; ?></td>
						<td><?php echo $query1['item_mat_name']; ?></td>
					</tr>
					<?php } ?>
				</table>
			</div>
