...
<html>
	...
	function insert_data()
	{
		...
		var billno=document.getElementById("txtopbalance").value;
		if(billno=="")
		{
			alert("Enter the Opening Balance..");
			$("#txtopbalance").focus();
			jj=0;
		}
		...
		///////end ////////
		 ...
		 $.post("pages/inv_insert_data.php",
		  {
			  type:"supplier_op_balance",
			  date:$("#txtorddate").val(), 
			  supplrid:$("#selectspplr").val(), 
			  opbalance:$("#txtopbalance").val(),
...
<div id="content-header">
    <div class="header_div"> <span class="header">Supplier Opening Balance</span></div>
</div>
<!--End-header-->
			...
			<div class="span11" style="margin-left:0px;">
				<table class="table table-bordered table-condensed">
			       ...
			       <tr>
						...
						<td>
							<input type="text" name="txtopbalance" id="txtopbalance" size="20" value="" class="imp" onkeyup="numentry('txtopbalance')"  />
						</td>
					</tr>
					...
					<tr>
						<td colspan="4" style="text-align:center">
							<input type="button" name="button2" id="button2" value="Reset" onclick="window.location='processing.php?param=169'" class="btn btn-danger" /> 
							<input type="button" name="button" id="button" value= "Save" onclick="insert_data()" class="btn btn-success" />
							<input type="button" name="button5" id="button5" value= "Print" onclick="popitup1('pages/inv_supplr_op_balance_rpt.php')"  />
						</td>
					</tr>
