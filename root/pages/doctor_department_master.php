	...
	<div class="row">
		<div class="span7">
			<table class="table   table-bordered table-condensed">
				<tr>
					<th>Demartment Name</th>
					<td>
						<input type="hidden" class="form-control" name="speciality_id" id="speciality_id" value="0" />
						<input type="text" class="form-control span4" name="dept_name" id="dept_name" onkeyup="caps_it(this.value,this.id,event)" autofocus />
					</td>
				</tr>
				<tr>
					<th>Prefix</th>
					<td>
						<input type="text" class="form-control span2" name="prefix" id="prefix" onkeyup="caps_it(this.value,this.id,event)" />
					</td>
				</tr>
				<tr>
