...
$filename ="referral_doctor_patient_reports_".$date1."_to_".$date2.".xls";
...
?>
	<table class="table table-condensed table-bordered">
		<tr>
			<td colspan="9">
				Referral Doctor Patient Reports from:</b> <?php echo convert_date($date1)." <b>to</b> ".convert_date($date2); ?>
			</td>
		</tr>
