	...
	foreach($res as $r)
	{
		...
		if($res_id)
		{
			...
			if($emp_id!="extra")
			{
				...
				if($con>0)
				{
				mysqli_query($link,"INSERT INTO `doctor_service_done`(`patient_id`, `ipd_id`, `service_id`, `consultantdoctorid`, `user`, `date`, `time`, `rel_slno`,`schedule_id`) VALUES ('$uhid','$ipd','$res_id','$con','$usr','$date','$time','0','$shed')");
				}
