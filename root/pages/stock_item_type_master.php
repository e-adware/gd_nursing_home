		...
		<table class="table table-bordered table-condensed">
			<tr style="display:none;">
				...
				<td>
					...
					<input type="text" value="0" id="item_type_id" readonly="readonly" class="span3" />
				</td>
			</tr>
			
			<tr>
				<td>Category Name</td>
				<td><input type="text" id="item_type_name" class="span3" placeholder="Type Name" autofocus /></td>
			</tr>
			<tr>
...
<script>
	...
	{
		load_category_list();
		$("#item_type_name").keyup(function(e)
		{
	...
	{
		$("#item_type_id").val(0);
		$("#item_type_name").val("").focus();
		
		$("#sav").val("Save");
	}
	function load_category_list()
	{
		$.post("pages/stock_item_type_master_data.php",
		{
			type:"load_item_type_list",
			user:$("#user").text().trim(),
	...
	function load_category_detail(item_type_id)
	{
		$.post("pages/stock_item_type_master_data.php",
		{
			type:"load_item_type_detail",
			item_type_id:item_type_id,
		},
		function(data,status)
		{
			var str=data.split("@#@");		
			$("#item_type_id").val(str[0]);
			$("#item_type_name").val(str[1]).focus();
	...
	function delete_category(item_type_id)
	{
		bootbox.dialog({
