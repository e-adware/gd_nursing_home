...
<script>
	...
	{
		var date_str="&param_str=131&fdate_str="+$("#fdate").val()+"&tdate_str="+$("#tdate").val()+"&uhid_str="+$("#uhid").val()+"&pin_str="+$("#ipd").val()+"&name_str="+$("#name").val()+"&phone_str="+$("#phone").val();
		
		window.location="processing.php?param=132&uhid="+uhid+"&ipd="+ipd+date_str;
	}
</script>
