...
<div id="content-header">
    <div class="header_div"> <span class="header">Indent Sub Category </span></div>
</div>
<!--End-header-->
	...
	<div class="span5" style="margin-left: 0;">
		<table class="table table-bordered table-condensed">
			...
			<tr>
				...
				<td><input type="text" id="name" class="span3" placeholder="sub category" autocomplete="off" autofocus /></td>
			</tr>
