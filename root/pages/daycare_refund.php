...
<style>
	...
	<table id="padd_tbl" class="table table-condensed">
		...
		<tr>
			...
			<th>Bill No</th>
			<td>
				<input type="text" id="search_pin" onkeyup="load_emp(this.value,event,'pin')" placeholder="Type OPD ID" autofocus />
			</td>
			<th>Name</th>
			<td>
...
function load_emp_details(uhid,opd_id,typ,v_typ)
{
	...
	setTimeout(function()
	{
		...
		window.location="processing.php?param=134&uhid="+uhid+"&opd="+opd_id;
	 }, 500);
}
//===========================================================
	function load_dist()
