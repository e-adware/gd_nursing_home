...
$prefix_det=mysqli_fetch_array(mysqli_query($link, " SELECT `p_type`,`type`,`prefix` FROM `patient_type_master` WHERE `p_type_id`='$dt_tm[type]' "));

$pat_info=mysqli_fetch_array(mysqli_query($link, " SELECT * FROM `patient_info` WHERE `patient_id`='$uhid' "));

//if($pat_info["dob"]!=""){ $age=age_calculator($pat_info["dob"]); }else{ $age=$pat_info["age"]." ".$pat_info["age_type"]; }
if($pat_info["dob"]!=""){ $age=age_calculator_date($pat_info["dob"],$dt_tm["date"]); }else{ $age=$pat_info["age"]." ".$pat_info["age_type"]; }
...
$refund_info=mysqli_fetch_array(mysqli_query($link, " SELECT * FROM `patient_refund` WHERE `patient_id`='$uhid' AND `opd_id`='$opd_id' AND `refund_request_id`='$refund_request_id' "));
	...
	<div class="container-fluid">
		...
		<?php
			...
			while($refund_det=mysqli_fetch_array($refund_det_qry))
			{
				...
				$service_name=$refund_det["service_name"];
