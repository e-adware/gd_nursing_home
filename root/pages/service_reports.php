		...
		<tr>
			<td>
				<center>
					...
					<br>
					<button class="btn btn-success" onClick="view_all('service_reports')">View</button>
				</center>
			</td>
		</tr>
	</table>
...
<script>
	...
	{
		$("#loader").show();
		$.post("pages/service_reports_data.php",
		{
			type:typ,
			date1:$("#from").val(),
			date2:$("#to").val(),
	...
	{
		if(val=="service_reports")
		{
			url="pages/service_reports_print.php?date1="+date1+"&date2="+date2;
		}
