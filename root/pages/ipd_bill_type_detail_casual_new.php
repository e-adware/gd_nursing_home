...
$ipd=mysqli_real_escape_string($link, base64_decode($_GET['opdid']));
			...
			<div>
				<table class="table table-condensed td_head" style="font-size:12px;border: 1px solid #000;">
					<tr>
						...
						<th>Reg Date</th><td>: <?php echo convert_date_g($dt['date'])." ".convert_time($dt['time']);?></td>
					</tr>
					<tr>
