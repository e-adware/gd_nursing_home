...
<div class="container-fluid">
		<table class="table table-condensed entry_table">
			...
			<tr class="tr_b">
				...
				<td>
					<input type="text" id="batch" class="span2" list="batch_list" placeholder="Batch No" />
		...
		<div id="old_item" style="display:none;width:99%;position:fixed;background: rgba(200, 210, 245, 0.6);left:1%;bottom:0%;max-height:200px;overflow-y:scroll;z-index:99999;"></div>
...
<script src="../jss/inv_purchase_receive_direct.js"></script>