...
<body onafterprint="window.close();" onkeyup="close_window(event)" onunload="refreshParent()">
	<div class="container-fluid">
		...
		<table class="table">
			...
			?>
			<tr>
				<td><b>Registration Fee</b> <span class="text-right"><?php echo number_format($consult_fee["regd_fee"],2); ?></span></td>
			</tr>
			<?php }
				$emr_check=0;
			?>
			...
			?>
			<tr>
				<td><b>Emergency Fee</b> <span class="text-right"><?php echo number_format($consult_fee["emergency_fee"],2); ?></span></td>
			</tr>
			<?php } ?>
			<tr>
				<td><b>Consultation Fee</b> (<?php echo $consult_name["Name"]." ,".$doc_info["qualification"]; ?>) <span class="text-right"><?php echo number_format($consult_fee["visit_fee"],2); ?></span></td>
			</tr>
			<tr>
			...
			?>
			<tr>
				<!--<th>Advance <span class="text-right"><?php echo number_format($adv_paid["amount"],2); ?></span></th>-->
				<th>Advance <span class="text-right"><?php echo number_format($consult_fee["advance"],2); ?></span></th>
			</tr>
			<?php
				$pat_bal="Balance\t\t\t\t\t\t\t\t\t".number_format($adv_paid["amount"],2);
			?>
			<tr>
				<!--<th>Balance <span class="text-right"><?php echo number_format(($consult_fee["tot_amount"])-($adv_paid["amount"])-($consult_fee["dis_amt"]),2); ?></span></th>-->
				<th>Balance <span class="text-right"><?php echo number_format($consult_fee["balance"],2); ?></span></th>
			</tr>
		</table>
		<p>Indian Rupees <?php echo convert_number($consult_fee["advance"]); ?> Only</p>
		<div class="span8"></div>
