			...
			<table id="patient_info_tbl" class="table table-condensed" style="background-color:#FFF">
				...
				<tr>
					...
					<td>
						...
						<input type="text" class="capital pat_info" id="pat_name" onKeyup="pat_name_up(this,event)" value="<?php echo $pat_name; ?>" style="width: 65%;">
					</td>
...
<script>
	...
	{
		$.post("pages/new_daycare_registration_data.php",
		{
			type:"load_center",
	...
	function pat_save()
	{
		...
		function(data,status)
		{
			...
			setTimeout(function(){
				...
				if(res[1]!="0")
				{
					window.location="processing.php?param=132&uhid="+res[0]+"&ipd="+res[1];
				}
				else
				{
					$("#save_tr").show();
