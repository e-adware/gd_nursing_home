...
<div id="content-header">
    <div class="header_div"> <span class="header">Sub store Indent issue</span></div>
</div>
<!--End-header-->
		...
		<form id="form1" method="post">
			<div class="span11" style="margin-left:0px;">
				<table class="table table-bordered table-condensed">
					...
					<tr>
						<td>Select Sub Store</td>
						<td >
							<select name="selectsubstr" id="selectsubstr"  autofocus>
								...
								<?php
									...
									{if($_POST['id']==$qsplr1['substore_id']){$ssel="Selected='selected'";} else { $ssel=" ";}
								?>
					...
					<tr>
						<td>Issue To</td>
						<td>
							<input type="text" name="tstissueto" id="tstissueto"   class="imp"  />
						</td>
					</tr>
