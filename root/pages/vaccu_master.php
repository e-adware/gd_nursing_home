...
<div id="content-header">
    <div class="header_div"> <span class="header"> Test Vaccu Master</span></div>
</div>
<!--End-header-->
			...
			<table class="table table-striped table-bordered table-condensed">
				...
				<tr>
					...
					<td>
						...
						<input type="text" name="txtname" id="txtname" class="imp" size="35"  autocomplete="off" />
					</td>
				</tr>
				<tr>
					<td> Rate</td>
					<td>
						<label for="txtname"></label>
						<input type="text" name="txtrate" id="txtrate" class="imp" size="20"  autocomplete="off" />
					</td>
				</tr>
				<tr>
					<td colspan="2" style="text-align:center" >
						...
						<input type="button" name="button3" id="button3" onclick="popitup('pages/vaccu_master_print.php');" value="View" class="btn btn-info" />
					</td>
				</tr>
			</table>
		</div>
...
<script>
	...
	function val_load_new(doid1)
	{
		...
		{		
			...
			document.getElementById("txtrate").value=val[2];
		 })
	}
	function clearr()
	{
