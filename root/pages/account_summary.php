...
<div id="content-header">
    <div class="header_div"> <span class="header"> Account Summary</span></div>
</div>
<!--End-header-->
		...
		<tr>
			<td>
				<center>
					...
					<br>
					<button class="btn btn-success" onClick="view_all('account_summary')">View</button>
				</center>
			</td>
		</tr>
	</table>
...
<script>
	$(document).ready(function(){
		...
		view_all('account_summary');
	});
	function view_all(typ)
	{
		$("#loader").show();
		$.post("pages/account_summary_data.php",
		{
			type:typ,
			date1:$("#from").val(),
			date2:$("#to").val(),
	...
	{
		if(val=="account_summary")
		{
			url="pages/account_summary_print.php?date1="+date1+"&date2="+date2;
		}
