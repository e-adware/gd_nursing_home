...
<div id="content-header">
    <div class="header_div"> <span class="header"> Result Options Master</span></div>
</div>
<!--End-header-->
			...
			<table class="table table-striped table-bordered table-condensed">
				<tr>
					...
					<td>
						...
						<input type="text" name="txtid" id="txtid" class="imp"  readonly="readonly"  />
					</td>
				</tr>
				<tr>
					<td>Name</td>
					<td>
						...
						<input type="text" name="txtname" id="txtname" class="imp span4" size="35" value="" autocomplete="off" />
					</td>
				</tr>						   
				<tr>
					<td colspan="2" style="text-align:center" >
						<input type="button" name="button" id="button" value="Submit" onclick="Insert();" class="btn btn-custom" />
						<input type="button" name="button2" id="button2" onclick="clearr();" value="Reset" class="btn btn-danger" />
						<!-- <input type="button" name="button3" id="button3" onclick="popitup('pages/ref_doc_list.php');" value="View" class="btn btn-custom" />-->
					</td>
				</tr>
			</table>
		</div>
...
<script>
	...
	function Insert() //For Insert
	{
		...
		if(jj==1)
		{
			...
			{
				type:"resultoption",
				opid:document.getElementById("txtid").value,
				opname:document.getElementById("txtname").value,
			},
			function(data,status)
			{
