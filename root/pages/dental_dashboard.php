...
<script>
	...
	{
		var date_str="&param_str=810&fdate_str="+$("#fdate").val()+"&tdate_str="+$("#tdate").val()+"&uhid_str="+$("#uhid").val()+"&pin_str="+$("#ipd").val()+"&name_str="+$("#name").val()+"&phone_str="+$("#phone").val();
		
		window.location="processing.php?param=809&uhid="+uhid+"&ipd="+ipd+date_str;
	}
</script>
