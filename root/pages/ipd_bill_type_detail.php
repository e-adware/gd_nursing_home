...
<html lang="en">
	...
	<body onafterprint="window.close();" onkeyup="close_window(event)">
			...
			<div>
				<table class="table table-condensed td_head" style="font-size:12px;border: 1px solid #000;">
					...
					<tr>
						...
						<th>Organization</th>
						<td>: <?php echo $source_name["source_type"]; ?></td>
					</tr>
		...
		?>
				<tr style="border-top:1px solid #000;">
					<td colspan="<?php echo $td_col_span; ?>">
						<b class="text-right" style="border-right:1px solid #000;">Advance Paid &nbsp; </b></td><td> &nbsp; <?php echo number_format($advance_amount,2);?>
					</td>
				</tr>
