	...
	<table id="padd_tbl" class="table">
		...
		<tr style="display:none;">
			...
			<td colspan="5">
				...
				<?php
					$pat_type_qry=mysqli_query($link, " SELECT * FROM `patient_type_master` WHERE `p_type_id`=5");
		...
		<tr>
			<td colspan="6">
				...
				<br>
				<center>
					<button class="btn btn-info" id="save" onClick="save('update_opd_pat_info')"><i class="icon-save"></i> Save</button>
...
<script src="../jss/day_reg.js"></script>
			...
			function(data,status)
			{
				...
				if(vl[2]==0)
				{
					...
					setTimeout(function()
					{
						if(vl[3]==5)
						{
							window.location="processing.php?param=132&uhid="+vl[0]+"&ipd="+vl[1];
						}
						if(vl[3]==8)
						{
