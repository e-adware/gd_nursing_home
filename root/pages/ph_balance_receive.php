...
function val_load_new(rid)///for retrieve data against Supplier
{
...
{
	$.post("pages/ph_load_unpaidbill.php",
	  {
		  type:"phpendngbill",
		  orderid:$("#txtcid").val(),
	  },
...
<div id="content-header">
    <div class="header_div"> <span class="header">Balance Received</span></div>
</div>
<!--End-header-->
