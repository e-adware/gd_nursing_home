<?php
	$casq=mysqli_query($link,"SELECT * FROM `uhid_and_opdid` WHERE `date`='$date' AND `type`='7'");
...
<div class="spap_dash span5">
	<button style="width:100%;background-color:#ddd;padding:5px;border:0;">Dental</button>
